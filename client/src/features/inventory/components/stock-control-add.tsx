...
const StockManagementAdd = ({show,setShow,medicines,setMedicines,index,setError}:StockManagementProps) => {
  const {setStockType,amount,setAmount,addToStock}=useAddStock(medicines,setMedicines);
  return ( 
  <Modal show={show} onHide={()=>setShow(false)}>
    <form onSubmit={addToStock}>
...
export default StockManagementAdd;