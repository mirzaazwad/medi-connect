...
const ChatTile = ({notifications,setNotifications}:ChatTileProps) => {
  ...
  return ( 
    <div className="chat-tile">
      ...
      <ChatTileElement senderID={send.senderID} senderType={send.senderType} imageURL={send.imageURL} senderName={send.senderName} message={send.message} datetime={send.datetime} notifications={send.notifications}/>
      )}
    </div>
